...
CREATE TABLESPACE "HSCMP_TBL" DATAFILE '+DATA(DATAFILE)/CLUSTERDB/DATAFILE/HSCMP/HSCMP_TBL' SIZE 20G AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED LOGGING EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;
-- 317.23602295 seconds
CREATE TABLESPACE "HSCMP_IDX" DATAFILE '+DATA(DATAFILE)/CLUSTERDB/DATAFILE/HSCMP/HSCMP_IDX' SIZE 6G AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED LOGGING EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;
-- 26.11306381 seconds
CREATE TABLESPACE "HSCMP_TBL_LOG" DATAFILE '+DATA(DATAFILE)/CLUSTERDB/DATAFILE/HSCMP/HSCMP_TBL_LOG' SIZE 500M AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED LOGGING EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;
-- 202.17424011 seconds
CREATE TABLESPACE "HSCMP_TBL_STK" DATAFILE '+DATA(DATAFILE)/CLUSTERDB/DATAFILE/HSCMP/HSCMP_TBL_STK' SIZE 4G AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED LOGGING EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;
-- 1089.2857666 seconds
CREATE TABLESPACE "HSCMP_TBL_SAL" DATAFILE '+DATA(DATAFILE)/CLUSTERDB/DATAFILE/HSCMP/HSCMP_TBL_SAL' SIZE 20G AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED LOGGING EXTENT MANAGEMENT LOCAL SEGMENT SPACE MANAGEMENT AUTO;
-- 8.41255188 seconds
CREATE TEMPORARY TABLESPACE "HSCMP_TEMP" TEMPFILE '+DATA(DATAFILE)/CLUSTERDB/DATAFILE/HSCMP/HSCMP_TEMP' SIZE 2G AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;
