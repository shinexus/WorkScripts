...
*****  YwStatus = '2' 已验收  *****************************************************
*****  YwStatus = '3' 已结案  *****************************************************/
SELECT * FROM tDstPsHead WHERE BillNo = '1001PSYW201312020047' ORDER BY LrDate;
...
/**** 更新单据状态，可以再次记账
UPDATE tDstPsHead SET TjDate = NULL, JzDate = NULL, DataStatus = '0' WHERE BillNo = '1001PSYW201312020047';
****/
...
SELECT * FROM tDstPsHead WHERE LrDate >= '2013-11-27' AND YwStatus <> '3' AND PSTYPE = '0' AND PsCount = '0';
UPDATE tDstPsHead SET YwStatus = '3' WHERE BillNo = '1001PSYW201401240167';
UPDATE tDstPsHead SET YwStatus = '3' WHERE LrDate >= '2013-11-27' AND PSTYPE = '0' AND JzDate IS NOT NULL AND PsCount = '0';
****/
...
/**** PluType = '1'(赠品)
/**** PluType = '2'（促销品） ****/
SELECT * FROM tDstPsBody WHERE BillNo = '1001PSYW201312020047' AND PluCode = '200203030';
/****
UPDATE tDstPsBody SET PluType = '0' WHERE BillNo = '1001PSYW201406270009' AND PluCode = '110006026';
****/
